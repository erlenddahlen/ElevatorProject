...
FSM:
-------
The FSM module is the Finite State Machine for controlling one elevator. It consists the four states
- Unknown
- Idle
- DoorOpen
- Moving
